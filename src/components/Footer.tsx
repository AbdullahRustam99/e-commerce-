  ...
  return (
    <>
      <div className="w-full bg-black text-white h-[] max-w-[1440px]">
        <div className=" px-20 py-20 justify-between gap-20 flex ">
        ...
        <div className="flex justify-between items-center  border-t-2 border-[#ffffff73] pt-2 pb-4 px-10">
          ...
          <div className="flex lg:gap-2 lg:w-[35%]">
            <p className="flex items-center text-[#ffffff73] text-[11px] font-medium pr-4  h-[14px]">
              Guides
            </p>
            <p className="flex items-center text-[#ffffff73] text-[11px] font-medium pr-4  h-[14px]">
              Terms of Sale
